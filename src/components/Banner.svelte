...
<section class = " h-screen flex flex-col items-center justify-between py-40">
  ...
  <div class="">
    <div class="bg-white text-center max-w-2xl p-6 shadow-lg">
  ...
  <div class="">
    <button on:click={sectionHandler} class="bg-mint text-white px-8 py-4 font-rale shadow-lg">Connect With Us</button>
  </div> 
</section>
