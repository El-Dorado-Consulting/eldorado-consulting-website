...
<section style="min-height:78vh" class="container flex flex-col mx-auto max-w-6xl my-12 px-4 font-source text-center">
	...
	<div class="flex flex-wrap justify-evenly">
		{#each posts as post, i}
			{#if !post.draft}
			<a href={"/blog/" + post.id} class="w-5/12 bg-gray-100 rounded-lg mt-10 transition-shadow hover:shadow-lg">
				<div class="h-56">
